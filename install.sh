...
Path=${1:-exercises/}
echo "cloning exercises at $Path..."
git clone -q https://github.com/solex-dev/exercises "$Path"

echo "Installing the 'solex' cli..."

git clone -q https://github.com/solex-dev/cli cli
...
echo "All done! Run 'solex' to get started."